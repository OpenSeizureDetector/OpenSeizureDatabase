...
Usage:
    ...
    python3 makeOsdDb.py --config osdb.cfg --osdb-dir /path/to/osdb
    
    # With index file generation
    python3 makeOsdDb.py --config osdb.cfg --osdb-dir /path/to/osdb --generate-index
    
    # With summary graph generation
    python3 makeOsdDb.py --config osdb.cfg --osdb-dir /path/to/osdb --generate-graphs
    
    # With both index and graph generation
    python3 makeOsdDb.py --config osdb.cfg --osdb-dir /path/to/osdb --generate-index --generate-graphs
    
    # Custom graph output directory
    python3 makeOsdDb.py --config osdb.cfg --osdb-dir /path/to/osdb --generate-graphs --graph-output /path/to/graphs
"""
...
def getUniqueEventsListsFromServer(configFname="osdb.cfg",
    ...
    time window are considered for grouping.
...
def loadExistingEvents(fname, debug=False):
    ...
    Returns a list of events, or empty list if file doesnt exist.
    """
