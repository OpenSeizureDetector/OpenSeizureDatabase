...
**Generated:** 2026-07-05 14:33:00

**Versions Compared:**
- **Baseline:** V1.10 (/home/graham/osd/osdb/V1.10)
- **Original:** Updated with current makeOsdDb.py (/home/graham/osd/osdb_test_original)
- **Refactored:** Updated with refactored makeOsdDb (/home/graham/osd/osdb_test_refactored)
...
|--------|----------------|------------------|--------------------|
| **Total Events** | 257 | 407 | 331 |
| **Added (vs V1.10)** | - | 150 | 110 |
...
- **New events only in Original:** 40
...
1. **Total Events Across All Types:**
   ...
   - Refactored Updated: 367

2. **Net Change:**
   - Original: +138 events (45.2%)
   - Refactored: +62 events (20.3%)
